        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Character-driven Storytelling</h4>
              <p>
                From storyboarding to final render, I breathe life into characters.
                Expertise in lip-sync, rigging basics, timing, and acting.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Character Animation</div>
                <div className="what-tags">Lip-sync</div>
                <div className="what-tags">Storyboarding</div>
                <div className="what-tags">Timing & Acting</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Polished Visual Content</h4>
              <p>
                Elevating visuals through advanced compositing and dynamic effects.
                Specialized in particle FX, motion design, and color grading.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Particle FX</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
